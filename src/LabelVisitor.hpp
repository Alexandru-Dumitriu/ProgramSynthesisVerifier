...
#define DELEGATE_LABEL(TO_CLASS)				\
	...
	void visitFunStartLabel(const FunStartLabel &lab) { return DELEGATE_LABEL(EventLabel); }
	void visitFunEndLabel(const FunEndLabel &lab) { return DELEGATE_LABEL(EventLabel); }
